        ...
        data.forEach((day) => {
            ...
            day.slots.forEach((slot) => {
                ...
                if (slot.course) {
                    ...
                    const courseInstructorContainer =
                        document.createElement("div");
                    courseInstructorContainer.className =
...
const group1Data = [
    {
        ...
        slots: [
            {
                course: "TP AGL C# (6-11)",
                instructor: "Hachmoud (24h) F14",
                className: "color-1",
                earlyStart: true,
                earlyFinish: true,
                colspan: 2,
            ...
            {
                course: "Org. des Entreprises (6-15)",
                instructor: "Bartat (20H)",
                className: "color-empty",
            },
            {
                course: "Tech. Rech. d'Emploi (6-16)",
                instructor: "Belkhou (20H)",
                className: "color-empty",
            },
        ],
    },
    {
        ...
        slots: [
            {
                course: "TP Gest. projets (6-10)",
                instructor: "Gmira (20H) F11",
                className: "color-2",
                colspan: 2,
            },
            {
                course: "TP OSI & TCP/IP (6-10)",
                instructor: "Khartoch (20H) F13",
                className: "color-4",
                colspan: 2,
            },
        ],
    },
    {
        ...
        slots: [
            ...
            {
                course: "TP Prog. Java (6-12)",
                instructor: "Benslimane (28H) F14",
                className: "color-5",
                colspan: 2,
            },
        ],
    },
    {
        ...
        slots: [
            {
                course: "entrepreneuriat (6-16)",
                instructor: "Lazaar (22H)",
                className: "color-empty",
            },
            {
            ...
            {
                course: "TP Tech. Web (6-10)",
                instructor: "Tmimi (20H) F14",
                className: "color-3",
                colspan: 2,
            },
        ],
